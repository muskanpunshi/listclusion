    ...
    <section >
      <Container className="bg-black/90 px-10 max-sm:!px-4 lg:py-32 py-10 rounded-b-4xl ">
        <div className="flex flex-col lg:flex-row lg:justify-between items-center gap-10">
          ...
          <div className="lg:w-3/5 fade-in-left">
          ...
          <div className="lg:w-2/5 lg:ml-auto fade-in-right">
            <Paragraph className="text-white text-2xl leading-normal">
              Your leading real estate advocate, transforming houses into dreams. Trust us to expertly guide you home
            </Paragraph>
          </div>
        </div>

      
        <div className="md:mt-28 mt-10 fade-in-up">
            ...
            <div className=" fade-in-up">
              <div className="flex items-center gap-4 ">
                ...
                <div className="text-white">
                  ...
                  <p className="text-sm">Elit esse cillum dol fug nulla tur nos ullamo.</p>
                </div>
              </div>
            </div>
            ...
            <div className=" fade-in-up">
              <div className="flex items-center gap-4 ">
                ...
                <div className="text-white">
                  ...
                  <p className="text-sm">quis nostrud exerct ulla security finibus ne derived.</p>
                </div>
              </div>
            </div>
            ...
            <div className=" fade-in-up">
              <div className="flex items-center gap-4 ">
                ...
                <div className="text-white">
                  ...
                  <p className="text-sm">Duis aute irure do reprehe de Cicero's voluptat velit.</p>
                </div>
              </div>
            </div>
          </div>
